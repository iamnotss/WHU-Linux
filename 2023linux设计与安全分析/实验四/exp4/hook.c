...
asmlinkage long fake_mkdir(const char __user *pathname, umode_t mode); // Added
...
asmlinkage long (*real_mkdir)(const char __user *pathname, umode_t mode); // Added
#else
...
asmlinkage long fake_mkdir(struct pt_regs *regs); // Added
...
asmlinkage long (*real_mkdir)(struct pt_regs *regs); // Added
#endif
